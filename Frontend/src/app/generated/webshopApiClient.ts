...
export class WebshopApiClient {
  ...
  product_SaveProduct(
    ...
    caffFile: FileParameter | null | undefined
  ): Observable<string> {
    ...
    if (caffFile !== null && caffFile !== undefined)
      content_.append(
        'CaffFile',
        caffFile.data,
        caffFile.fileName ? caffFile.fileName : 'CaffFile'
      );
  ...
  protected processProduct_SaveProduct(
  ...
  protected processProduct_UpdateProduct(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
  ...
  ): Observable<IPagedListOfProductDto> {
    let url_ = this.baseUrl + '/api/product?';
    if (pageIndex === null)
          ...
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<IPagedListOfProductDto>;
            }
          } else
            return _observableThrow(
              response_
  ...
  protected processProduct_ListProducts(
    response: HttpResponseBase
  ): Observable<IPagedListOfProductDto> {
    const status = response.status;
    const responseBlob =
  ...
  protected processProduct_DeleteProduct(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
  ...
  protected processProduct_ListOwnProducts(
    response: HttpResponseBase
  ): Observable<IPagedListOfProductDto> {
    const status = response.status;
    const responseBlob =
  ...
  protected processProduct_ListBoughtProducts(
    response: HttpResponseBase
  ): Observable<IPagedListOfProductDto> {
    const status = response.status;
    const responseBlob =
  ...
  protected processProduct_GetProductDetails(
    response: HttpResponseBase
  ...
  protected processProduct_GetBoughtFile(
    response: HttpResponseBase
  ...
  protected processProduct_BuyProduct(
    response: HttpResponseBase
  ): Observable<FileResponse> {
    const status = response.status;
    const responseBlob =
  ...
  protected processComment_SaveComment(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
  ...
  protected processComment_UpdateComment(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
  ...
  protected processComment_DeleteComment(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
